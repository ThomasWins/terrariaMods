using PoopSword.Content.NPCs.FirstBoss;
using Terraria;
using Terraria.Audio;
using Terraria.ID;
using Terraria.ModLoader;

namespace PoopSword.Content.Items.Consumables
{
	...
	public class FirstBossSummonItem : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<FirstBossBody>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<FirstBossBody>();
